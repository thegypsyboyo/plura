  ...
  return (
    <>
      <section className="min-h-full w-full md:pt-44 mt-[-70px] relative flex items-center justify-center flex-col ">
        ...
        <div className="relative">
          <h1
            className="text-9xl font-bold text-center md:text-[300px] bg-gradient-to-r from-primary to-secondary-foreground"
            style={{
              backgroundClip: "text",
        ...
        <div className="flex justify-center items-center relative md:mt-[-70px]">
          <Image
            ...
            height={1200}
            width={1200}
            className="rounded-tl-2xl w-full h-full object-cover rounded-tr-2xl border-2 border-muted"
          />
